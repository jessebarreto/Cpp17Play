...
class Shape : public Prototype {
 ...
 public:
  ...
  std::pair<double, double> position() const { return std::make_pair(_x, _y); }
};
...
class Rectangle : public Shape {
 ...
 public:
  Rectangle(double width, double height)
      : Shape(0.0, 0.0), _width{width}, _height{height} {}
...
class Circle : public Shape {
 ...
 public:
  ...
  Prototype& clone() const override { return *(new Circle(_radius)); }
};

TEST(
    PrototypeTest,
    GIVEN_DerivedInstanceOfPrototype_When_CloningPrototype_Then_SuccessfullyClone) {
  Circle circle(3.14);
