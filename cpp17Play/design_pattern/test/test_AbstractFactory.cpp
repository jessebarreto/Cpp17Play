...
public:
    Rectangle(float width = 0.0, float height = 0.0) : _width(width), _height(height) {}
...
TEST(AbstractFactoryTests, GIVEN_Inheriting_AbstractFactory_For_Shape_WHEN_Calling_Create_Method_THEN_Corretly_Apply_Factory) {
    std::unique_ptr<AbstractFactory<AbstractGeometry, ShapeEnum>> factory = nullptr;
...
TEST(AbstractFactoryTests, GIVEN_Inheriting_AbstractFactory_For_Solid_WHEN_Calling_Create_Method_THEN_Corretly_Apply_Factory) {
    std::unique_ptr<AbstractFactory<AbstractGeometry, ShapeEnum>> factory = nullptr;
